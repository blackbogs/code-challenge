  ...
  return (
    <div className="h-[200px] bg-transparent">
      <div className="relative flex justify-center">
        <img src="/img/footer-desktop.webp" alt="footer" loading="lazy" className="absolute w-screen h-[500px] mobile:hidden bg-transparent z-50 mt-[-100px]" /> {/* for desktop */}
        <img src="/img/footer-mobile.webp" alt="footer"  loading="lazy" className=" mt-[-90px] w-screen h-[600px] bg-transparent desktop:hidden tablet:hidden" /> {/* for mobile */}

        {/* for mobile */}
        <div className="w-[80vw] absolute my-10 desktop:hidden">
          <div>
            <Link href={"/"}>
              <img src="/img/logo footer-mobile.webp" alt="logo" loading="lazy" className="w-[200px] mt-[-50px]" />
            </Link>
          </div>
        ...
        <div className="absolute z-50 mobile:hidden">
          ...
          <div className="w-[75vw] flex flex-row justify-between mt-[120px] text-[15px] font-Monstserrat text-white">
            <div>
              <Link href={"/"}>
                <img src="/img/logo footer-mobile.webp" alt="logo" loading="lazy" className="w-[200px]" />
              </Link>
            </div>
