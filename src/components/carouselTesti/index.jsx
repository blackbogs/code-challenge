...
function TestiCarousel() {
  return (
    <div className="h-screen mt-[-100px]">
      <Carousel slide={true} slideInterval={1000} className="desktop:hidden">
        <div className="flex justify-center">
          <div className="rounded-tr-[50px] rounded-bl-[50px] w-[300px] h-[400px] flex flex-col items-center text-center gap-5 bg-gradient-to-l from-gray-400">
            <img src="/img/foto testi 1.webp" className="rounded-full size-[100px] object-cover m-[-50px]" />
        ...
        <div className="flex justify-center">
        <div className="rounded-tr-[50px] rounded-bl-[50px] w-[300px] h-[400px] flex flex-col items-center text-center gap-5 bg-gradient-to-l from-gray-400">
            <img src="/img/foto testi 2.webp" className="rounded-full size-[100px] object-cover m-[-50px]" />
        ...
        <div className="flex justify-center">
        <div className="rounded-tr-[50px] rounded-bl-[50px] w-[300px] h-[400px] flex flex-col items-center text-center gap-5 bg-gradient-to-l from-gray-400">
            <img src="/img/foto testi 3.webp" className="rounded-full size-[100px] object-cover m-[-50px]" />
      ...
      <Carousel slide={true} slideInterval={3000} className="mobile:hidden">
        <div className="flex justify-center">
          <div className="rounded-tr-[50px] rounded-bl-[50px] w-[850px] h-[400px] flex flex-col items-center text-center gap-5 bg-gradient-to-l from-gray-400">
            <img src="/img/foto testi 1.webp" className="rounded-full size-[150px] object-cover m-[-50px]" />
        ...
        <div className="flex justify-center">
        <div className="rounded-tr-[50px] rounded-bl-[50px] w-[850px] h-[400px] flex flex-col items-center text-center gap-5 bg-gradient-to-l from-gray-400">
            <img src="/img/foto testi 2.webp" className="rounded-full size-[150px] object-cover m-[-50px]" />
        ...
        <div className="flex justify-center">
        <div className="rounded-tr-[50px] rounded-bl-[50px] w-[850px] h-[400px] flex flex-col items-center text-center gap-5 bg-gradient-to-l from-gray-400">
            <img src="/img/foto testi 3.webp" className="rounded-full size-[150px] object-cover m-[-50px]" />
