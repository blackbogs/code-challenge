...
function SkincareCarousel() {
  return (
    <div className="h-full px-[20px] mt-[-80px] desktop:hidden">
      <Carousel slide={false} slideInterval={1000}>
        <div>
          <div className="relative flex flex-row items-center justify-between w-screen text-center h-[100px] pt-[50px]">
            <div className=" bg-orange-300 rounded-tr-[50px] h-[50px] w-[220px] flex items-center">
               <h1 className="text-white font-semibold font-Monstserrat text-[13px] ml-5">Ampoule for White Series</h1>
            </div>
        ...
        <div>
          ...
          <div className="relative flex flex-row items-center justify-between w-screen text-center h-[100px] pt-[50px]">
            <div className=" bg-orange-300 rounded-tr-[50px] h-[50px] w-[220px] flex items-center">
               <h1 className="text-white font-semibold font-Monstserrat text-[13px] ml-5">Ampoule for Acne Series</h1>
            </div>
